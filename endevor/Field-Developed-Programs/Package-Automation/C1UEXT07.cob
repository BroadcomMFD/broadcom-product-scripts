...
*********  For many conditions, call REXX and let it decide what to do
      ...
      *****
           ...
           STRING
              ...
              'PECB_MODE = "' PECB-MODE '";'
              'PREQ_EXEC_START_DATE = "' PREQ-EXEC-START-DATE '";'
              'PREQ_EXEC_START_TIME = "' PREQ-EXEC-START-TIME '";'
              'PREQ_EXEC_END_DATE   = "' PREQ-EXEC-END-DATE '";'
              'PREQ_EXEC_END_TIME   = "' PREQ-EXEC-END-TIME '";'
...
*******    Replace any double quote characters in data to be passed
           IF CAST-PACKAGE OR REVIEW-PACKAGE OR EXECUTE-PACKAGE
