...
/*                                                                   */         
/* This rexx is an optionally called subroutine.                     */         
/* It can help keep track of the status of each package shipment     */         
/* by modifying the status field (St) on the Trigger file entry.     */         
/*                                                                   */         
/* Update the Trigger file at the completion of package shipment     */         
/* Optionally use UPDTTGGR to reflect these status values:           */         
/*   _ means that the shipment entry is created                      */         
/*   s means that the local  shipment job has been submitted         */         
/*   S means that the remote shipment job has been submitted         */         
/*   / means that the shipment is completed (Notification job too)   */         
/*  12 means that the shipment failed                                */         
/*                                                                   */         
