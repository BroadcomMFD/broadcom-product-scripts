...
***********************************************************************         
*   DESCRIPTION: THIS PACKAGE EXIT PROGRAM                            *         
*                calls the rexx program PKGESHIP to support           *         
*                automated package shipping submissions.              *         
*                (Automated Package Executions not supported)         *         
*                                                                     *         
...
*        DC    CL28'DA(YOURSITE.NDVR.REXX)'                                     
         DC    CL30'DA(YOURSITE.NDVR.TEAM.REXX)'                                
*        DC    CL28'DA(SYS?.EXEC)'                                              
*  Enter your REXX dataset name and length here /                               
         DC    CL42' SHR REUSE'                                                 
*        DC    CL40'----+----1----+----2----+----3----+----4                    
