...
**C1UEXTR7.rex** is an example Rexx subroutine to a COBOL package exit program, for example [C1UEXT07](https://github.com/BroadcomMFD/broadcom-product-scripts/blob/main/endevor/Field-Developed-Programs/Exit-Examples/C1UEXT07%20WithRexDriver.cob) in the **Exits-Examples** folder, or [C1UEXTT7](https://github.com/BroadcomMFD/broadcom-product-scripts/blob/main/endevor/Field-Developed-Programs/SonarQube-interface-to-Endevor/C1UEXTT7.cob) in the **SonarQube-interface-to-Endevor** folder. This version of C1UEXTR7 processes Approver Group names, provided by the exit, and calls **SENDMAIL.rex** to deliver email. 
