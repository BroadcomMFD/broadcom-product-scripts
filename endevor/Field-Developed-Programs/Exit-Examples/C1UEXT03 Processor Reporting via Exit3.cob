      ...
      *****************************************************************
      * DESCRIPTION: THIS PGM IS CALLED after  Element processing     *
      ...
      *****************************************************************
       ...
       77  RETURN-CODE-FOR-DISPLAY           PIC 9(10).
      ...
      * The bulk of the logic is found in C1UEXTR3
       01  ELM-C1UEXTR3-PARMS-IRXJCL.
         02  ELM-EXECUTE-PARMS-IRXJCL-TOP.
           03 PARM-LENGTH           PIC X(02) VALUE X'0711'.
           03 REXX-NAME             PIC X(08) VALUE 'C1UEXTR3'.
           03 FILLER                PIC X(01) VALUE SPACE .
         02  ELM-EXECUTE-PARMS-IRXEXEC.
      ...
      *****
           ...
           STRING
                  ...
                  '";'
                     DELIMITED BY SIZE
                 'SRC_ELM_PROCESSOR_NAME = "'
                    DELIMITED BY SIZE
                  SRC-ELM-PROCESSOR-NAME
                    DELIMITED BY SIZE
                 '";'
                    DELIMITED BY SIZE
                 'SRC_ELM_PROCESSOR_LAST_DATE = "'
                    DELIMITED BY SIZE
                  SRC-ELM-PROCESSOR-LAST-DATE
                    DELIMITED BY SIZE
                 '";'
                    DELIMITED BY SIZE
                 'TGT_ELM_PROCESSOR_NAME = "'
                    DELIMITED BY SIZE
                  TGT-ELM-PROCESSOR-NAME
                    DELIMITED BY SIZE
                 '";'
                    DELIMITED BY SIZE
                 'TGT_ELM_PROCESSOR_LAST_DATE = "'
                    DELIMITED BY SIZE
                  TGT-ELM-PROCESSOR-LAST-DATE
                    DELIMITED BY SIZE
                 '";'
                    DELIMITED BY SIZE
           ...
           MOVE    REQ-ACTION-RC TO RETURN-CODE-FOR-DISPLAY.
           STRING
                  'REQ_ACTION_RC = '
                     DELIMITED BY SIZE
              ...
              INTO   WS-REXX-STATEMENTS
              WITH POINTER WS-POINTER .
           MOVE    ECB-HIGH-RC   TO RETURN-CODE-FOR-DISPLAY.
           STRING
                  'ECB_HIGH_RC = '
                     DELIMITED BY SIZE
                   RETURN-CODE-FOR-DISPLAY
           ...
           IF SRC-ENV-TYPE-OF-BLOCK = 'E'
              MOVE SRC-ELM-PROCESSOR-RC TO RETURN-CODE-FOR-DISPLAY
              STRING
                  'SRC_ELM_PROCESSOR_RC = '
                     DELIMITED BY SIZE
                   RETURN-CODE-FOR-DISPLAY
                     DELIMITED BY SIZE
                  ';'
              ...
              WITH POINTER WS-POINTER
              END-STRING .
           IF TGT-ENV-TYPE-OF-BLOCK = 'E'
              MOVE TGT-ELM-PROCESSOR-RC TO RETURN-CODE-FOR-DISPLAY
              STRING
                  'TGT_ELM_PROCESSOR_RC = '
                     DELIMITED BY SIZE
                   RETURN-CODE-FOR-DISPLAY
                     DELIMITED BY SIZE
                  ';'
