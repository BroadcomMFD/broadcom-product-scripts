//*****************************************************************
//**  GJCL     New JCLCHECK processor                            **
//**  04/04/2020 JCL Original processor.                         **
//**                                                             **
//*****************************************************************
//*--------------------------------------------------------------------*
//JCLGCA7C PROC AAAAAA=,
...
//    JCL#OPT2=' V PROC(SYSPROC)                  ',
//    JCL#OPT3=' F SX RP ER( END)                 ',
//    JCL#OPT4=' SYN RUNT  J                      ',
//    JCL#OPT5=' NOAUD NOAUTOP                    ',
//    JCL#OPT6=' NOPDS                            ',
//    LASTNODE=JCL,                         Last node for datasets
//*   LASTNODE=&LASTND@&ETYP,               Last node for datasets
//*     LASTND@T='CA7QTST',                      for prgrp ending T
//*     LASTND@Q='CA7QQA',                       for prgrp ending Q
//    OUTLIB='YOURSITE.NDVR.&&C1ENVMNT.&&C1SYSTEM.&&C1SU.&LASTNODE',
//    PARM='OPTIONS(JCLOPTS)',
//    PRCLIB='YOURSITE.NDVR.&&C1ENVMNT.&&C1SYSTEM.&&C1SU.PROC',
//    LSTLIB='YOURSITE.NDVR.&&C1ENVMNT.&&C1SYSTEM.&&C1SU.LISTLIB',
//    PRDLIB='',        your.SUBLIB..&LASTNODE
//    SHOWME='Y',       Show diagnostics & intermediate results Y/N
//    QAST='QAST',
//    SYSEXEC='your.JCLCHECK.R1200A.CAZ2CLS0',
//    ZZZZZZZ=                              the end
//*
//*--------------------------------------------------------------------*
...
//          DD DISP=SHR,DSN=your.PROCLIB,
//             ALLOC=COND,MONITOR=COMPONENTS
//          DD DISP=SHR,DSN=your.PROCLIB,
//             ALLOC=COND,MONITOR=COMPONENTS
//          DD DISP=SHR,DSN=your.PROCLIB.REMOTE,
//             ALLOC=COND,MONITOR=COMPONENTS
//          DD DISP=SHR,DSN=your.PROCLIB,
//             ALLOC=COND,MONITOR=COMPONENTS
//          DD DISP=SHR,DSN=your.PRODUSER,
//             ALLOC=COND,MONITOR=COMPONENTS
//          DD DISP=SHR,DSN=your.PROCLIB,
//             ALLOC=COND,MONITOR=COMPONENTS
//          DD DISP=SHR,DSN=your.PROCLIB,
...
//POSITION DD DISP=SHR,DSN=YOURSITE.NDVR.TEAM.PARM(JCLCKXRF)
//OPTIONS  DD  *
...
//MODELPGM DD *
  RELATE MEMBER &XRF_DSN_MEM
      ...
      INPUT.
//SYSEXEC  DD DISP=SHR,DSN=your.NDVR.CSIQCLS0
//SYSTSPRT DD SYSOUT=*                                REXX MESSAGES
