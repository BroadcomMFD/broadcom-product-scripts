...
Get_COPY_library_name_list:
   ...
   IF ENVSENV = 'DEV'      then,
     INCLUDE_LIBRARY_LIST  =,
         'SYSMD32.ALIAS.'ENVBSYS'.'ENVBSBS'.COPY1',
         'SYSMD32.ALIAS.'ENVBSYS'.'ENVBSBS'.COPY2',
         'SYSMD32.ALIAS.'ENVBSYS'.'ENVBSBS'.COPY3',
         'SYSMD32.ALIAS.'ENVBSYS'.'ENVBSBS'.COPY4',
         'SYSMD32.ALIAS.'ENVBSYS'.'ENVBSBS'.COPY5',
         'SYSMD32.ALIAS.'ENVBSYS'.'ENVBSBS'.COPY6',
         'SYSMD32.NDVR.DEV.FINANCE.'ENVBSBS'.COPYBOOK',
         'SYSMD32.NDVR.DEV.FINANCE.ACCTPAY.COPYBOOK',
         'SYSMD32.NDVR.DEV.FINANCE.ACCTREC.COPYBOOK',
         'SYSMD32.NDVR.QAS.FINANCE.ACCTPAY.COPYBOOK',
         'SYSMD32.NDVR.QAS.FINANCE.ACCTREC.COPYBOOK',
         'SYSMD32.NDVR.PRD.FINANCE.ACCTPAY.COPYBOOK',
         'SYSMD32.NDVR.PRD.FINANCE.ACCTREC.COPYBOOK'
   ELSE,
   IF ENVSENV = 'QAS'      then,
      INCLUDE_LIBRARY_LIST =,
         'SYSMD32.NDVR.QAS.FINANCE.ACCTPAY.COPYBOOK',
