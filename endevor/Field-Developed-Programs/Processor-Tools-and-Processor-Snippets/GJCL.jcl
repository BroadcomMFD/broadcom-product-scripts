//*****************************************************************
//**  GJCL  to build relationships between this JCL/Proc and...  **   
//**      procs, programs, datasets ...                          **
//**   See "XREF Reporting Using the UPDTDSN/UPDTDD Options"     ** 
//**       in the JCLCHECK Techdocs documentation                **
//**                                                             **
...
//    OUTLIB='SYSMD32.NDVR.&&C1ENVMNT.&&C1SYSTEM.&&C1SU.&LASTNODE',
//    PARM='OPTIONS(JCLOPTS)',
//    PRCLIB='SYSMD32.NDVR.&&C1ENVMNT.&&C1SYSTEM.&&C1SU.PROC',
//    LSTLIB='SYSMD32.NDVR.&&C1ENVMNT.&&C1SYSTEM.&&C1SU.LISTLIB',
...
//POSITION DD DISP=SHR,DSN=SYSMD32.NDVR.TEAM.PARM(JCLCKXRF)
//OPTIONS  DD  *
