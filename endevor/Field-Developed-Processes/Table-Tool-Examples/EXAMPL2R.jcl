//WALJO112 JOB (55800000),
//      'ENDEVOR JOB',MSGLEVEL=(1,1),CLASS=B,REGION=0M,MSGCLASS=A,
//      NOTIFY=&SYSUID
//*-------------------------------------------------------------------
// SET CSVFILE=WALJO11.PHONS.CSVFILE.#2
// SET CSVFILE=WALJO11.PHONS.CSVFILE.#3
// SET CSVFILE=WALJO11.PHONS.CSVFILE.#4
// SET CSVFILE=WALJO11.PHONS.CSVFILE
// SET SYSEXEC=WALJO11.REXX
