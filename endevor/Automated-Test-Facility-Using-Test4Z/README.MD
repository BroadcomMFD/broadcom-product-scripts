...
An assessment of the completed Test is made automatically to make it easier for you to know the results. One of the outputs will be given, as done in this example job output: 
