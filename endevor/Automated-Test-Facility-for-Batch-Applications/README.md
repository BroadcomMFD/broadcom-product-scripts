...
Note: Members OPTVALDT, TXTRPLCE and YAML2REX are REXX subroutines required for the **Automated Test Facility for Batch Applications**. They are used by more than one solution on this GitHub, but can be found under the **Field-Developed-Processes** folder in the **Processor-Tools-and-Processor-Snippets** subfolder.
