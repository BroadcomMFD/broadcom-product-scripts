...
public class Main {
  ...
  private static final String DEFINE_FAVORITE_FORM = "/forms/DefineFavorite.fxml";
  private static final String ENDPOINT_FORM = "/forms/Endpoint.fxml";
  private static final String LOGIN_FORM = "/forms/Login.fxml";
  private static final String FAVORITES_FORM = "/forms/Favorites.fxml";
  ...
  public Main(Injector injector) throws IOException {
    ...
    prepareStage(injector, DEFINE_FAVORITE_FORM, "Define Favorite", true, stylesUrl);
    ...
    favorites = prepareStage(injector, FAVORITES_FORM, "Web Viewer - Favorites", false, stylesUrl);
  }
   ...
   */
  private <T> T prepareStage(Injector injector, String form, String title, boolean modal, URL stylesUrl)
      throws IOException {
